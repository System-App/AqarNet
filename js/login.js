/**
 * login.js — Login screen for Aqar Net
 *
 * Two tabs:
...
export function renderLogin(container) {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      console.error('[Aqar Net] Login error:', err);
  ...
  const screen = el('div.auth', {}, [
    el('div.auth__brand', {}, [
      el('div.auth__logo', {}, [el('img', { src: 'icons/icon-512-dark.png', alt: 'Aqar Net' })]),
      el('div.auth__title', {}, 'Aqar Net'),
