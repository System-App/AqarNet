/**
 * db.js — Firestore data layer for Aqar Net
 *
 * Collection structure (all under companies/aqar-net):
 *   companies/aqar-net/meta/settings      — work hours, grace, zone, etc.
 *   companies/aqar-net/employees/{uid}    — name, code, role, createdAt
 *   companies/aqar-net/attendance/{id}    — employeeId, date, checkIn, checkOut, ...
 *   companies/aqar-net/dayStatus/{id}     — employeeId, date, type, note
 *   companies/aqar-net/holidays/{id}      — date, name
 *
...
export async function importAllData(payload) {
  if (!payload || payload.app !== 'aqar-net-attendance') {
    throw new Error('فایلەکە بۆ سیستەمی Aqar Net نییە');
  }
