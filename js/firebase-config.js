/**
 * firebase-config.js — Firebase initialization for Aqar Net Attendance
 *
...
// ──────────────────────────────────────────────────────────────────
// PROJECT CONFIG — Aqar Net
// ──────────────────────────────────────────────────────────────────
const firebaseConfig = {
  apiKey: 'AIzaSyDDSYm7qX8PSi7hMhF8dFe5g-ywxKi-I0U',
  authDomain: 'aqar-net-2026.firebaseapp.com',
  projectId: 'aqar-net-2026',
  storageBucket: 'aqar-net-2026.firebasestorage.app',
  messagingSenderId: '827567869218',
  appId: '1:827567869218:web:0fe2709fdfa2def26c697b',
};
...
setPersistence(auth, browserLocalPersistence).catch((err) =>
  console.warn('[Aqar Net] Auth persistence error:', err)
);
...
export const COMPANY_ID = 'aqar-net';
